      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1 font-medium">
            Manage and optimize your builder workflows with AI-driven insights.
          </p>
        </div>
        ...
        <CardHeader className="border-border/50 border-b pb-8">
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>
                Comprehensive overview of your builder ecosystem.
              </CardDescription>
            </div>
        ...
        <div className="flex items-center gap-6">
          ...
          <div>
            ...
            <p className="text-muted-foreground text-sm">
              Our neural networks are ready to automate your builder management.
            </p>
          </div>
        </div>
