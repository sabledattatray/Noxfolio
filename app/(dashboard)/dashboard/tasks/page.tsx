  ...
  return (
    <div className="animate-in fade-in slide-in-from-bottom-4 space-y-8 duration-700">
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1 font-semibold">
            Monitor and assign operational tasks across your organization.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
        <StatCard title="Pending Tasks" value="24" trend="-15.5%" />
        <StatCard title="Completion Velocity" value="8.4/day" trend="+2.4%" />
        <StatCard title="Overdue Items" value="3" trend="+50%" isHighlight />
      </div>
        ...
        <CardHeader className="border-border/50 border-b pb-8">
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>
                Comprehensive overview of your tasks ecosystem.
              </CardDescription>
            </div>
            ...
            {[
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h4 className="text-foreground font-semibold">{task}</h4>
                    <p className="text-muted-foreground text-xs">
                      Priority: {i < 2 ? 'High' : 'Normal'} • Assigned to: Lead
                      Dev
                    </p>
                  </div>
                </div>
        ...
        <div className="flex items-center gap-6">
          ...
          <div>
            ...
            <p className="text-muted-foreground text-sm">
              Our neural networks are ready to automate your tasks management.
            </p>
          </div>
        </div>
