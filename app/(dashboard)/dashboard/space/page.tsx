  ...
  return (
    <div className="animate-in fade-in slide-in-from-bottom-4 space-y-8 duration-700">
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1 font-medium">
            Collaborative workspace and document management environment.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
        <StatCard title="Storage Used" value="124 GB" trend="of 500GB" />
        <StatCard
        ...
        <CardHeader className="border-border/50 border-b pb-8">
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>
                Comprehensive overview of your space ecosystem.
              </CardDescription>
            </div>
            ...
            {[
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h4 className="text-foreground font-medium">{space}</h4>
                    <p className="text-muted-foreground text-xs">
                      Owner: {i < 2 ? 'Marketing' : 'Legal'} • Size:{' '}
                      {10 + i * 5} MB
                    </p>
                  </div>
                </div>
        ...
        <div className="flex items-center gap-6">
          ...
          <div>
            ...
            <p className="text-muted-foreground text-sm">
              Our neural networks are ready to automate your space management.
            </p>
          </div>
        </div>
