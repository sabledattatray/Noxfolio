  ...
  return (
    <div className="animate-in fade-in slide-in-from-bottom-4 space-y-8 duration-700">
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1 font-medium">
            Analyze web traffic and user engagement in real-time.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
        <StatCard title="Daily Visitors" value="14.2k" trend="+12.5%" />
        <StatCard title="Bounce Rate" value="32.4%" trend="-2.4%" />
        <StatCard title="Avg. Session" value="4m 12s" trend="+8%" isHighlight />
      </div>
        ...
        <CardHeader className="border-border/50 border-b pb-8">
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>
                Comprehensive overview of your visitors ecosystem.
              </CardDescription>
            </div>
        ...
        <CardContent className="p-0">
          <div className="divide-border/50 divide-y">
            {[
              ...
              'Direct Referral - Twitter',
              'Search Engine Query - BI',
              'Email Campaign - Spring',
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h4 className="text-foreground font-medium">{visitor}</h4>
                    <p className="text-muted-foreground text-xs">
                      Source: {i < 2 ? 'Social' : 'Organic'} • Device:
                      Mobile/Desktop
                    </p>
                  </div>
                </div>
        ...
        <div className="flex items-center gap-6">
          ...
          <div>
            ...
            <p className="text-muted-foreground text-sm">
              Our neural networks are ready to automate your visitors
              management.
            </p>
          </div>
        </div>
