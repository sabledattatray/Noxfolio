  ...
  return (
    <div className="animate-in fade-in slide-in-from-bottom-4 space-y-8 duration-700">
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1 font-semibold">
            Manage your inventory and product catalog with integrated AI
            analytics.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
        <StatCard title="Total SKU Count" value="156" trend="+2.5%" />
        <StatCard title="Avg. Margin" value="42.8%" trend="+1.2%" />
        <StatCard title="Bestsellers" value="12" trend="+15%" isHighlight />
      </div>
        ...
        <CardHeader className="border-border/50 border-b pb-8">
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>
                Comprehensive overview of your products ecosystem.
              </CardDescription>
            </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-xs">
                      SKU: PROD-{(1000 + i * 100).toString()} • Price: $
                      {(99 + i * 100).toString()}/mo
                    </p>
                  </div>
                </div>
        ...
        <div className="flex items-center gap-6">
          ...
          <div>
            ...
            <p className="text-muted-foreground text-sm">
              Our neural networks are ready to automate your products
              management.
            </p>
          </div>
        </div>
